...
import {ExtendedLikesInfo, NewestLike} from "../../../../../likes/api/models/likes.info.model";
...
export class PostMapper {
    public static toView(post:PostDocument, likes:ExtendedLikesInfo):PostOutputDto{
        return {
