...
import {
    ...
    LoginInputDto,
    NewPasswordDto,
    PasswordRecoveryDto, RegistrationEmailResendingDto
...
export class AuthController {
    ...
    async newPassword(@Body() newPasswordDto: NewPasswordDto) {
        return await this.authService.newUserPassword(newPasswordDto.newPassword, newPasswordDto.recoveryCode)//done, not tested
    }
