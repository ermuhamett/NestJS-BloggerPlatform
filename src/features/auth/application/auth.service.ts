...
export class AuthService {
    ...
    async registerUser(dto: UserCreateDto) {
        try {
            ...
            await this.emailService.sendRegistrationEmail(createdUser.email,createdUser.emailConfirmation.confirmationCode)
        } catch (error) {
    ...
    async passwordRecovery(email:string){
        ...
        await user.save()
        try {
            await this.emailService.sendPasswordRecoveryEmail(email, user.emailConfirmation.passwordRecoveryCode)
        }catch (error) {
